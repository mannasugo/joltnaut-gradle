    ...
    protected void onPostExecute(String IOContent) {
      ...
      if (IOContent != null) {
        ...
        try {
          ...
          JSONObject PollMug = new JSONObject(IOContent);

          ver = PollMug.getString("APK_VER");

          if (ver.equals(APK_VER)) {

            if (PollMug.has("md")) {

              Journalise.putString("md", PollMug.getString("md"));

              Intent intent = new Intent(PollMug.this, Root.class);
